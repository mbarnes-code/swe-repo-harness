...
- **Blocker B.** "The abandoned provider's last published version" has no durable field, not just
  ...
  (`cli.py:7604-7644`, moved by round VI task 58's `cli.py` insertions) always constructs
...
- **Blocker C (newly found, not previously flagged).** No code branch reclassifies a stubbed
  `C → P` edge from internal to external — `_unit_deps` (`cli.py:7714-7807`, moved by round VI
...
blockers above**: `_eligible_build_units` (`cli.py:9494-9529`, moved by round VI task 58's
