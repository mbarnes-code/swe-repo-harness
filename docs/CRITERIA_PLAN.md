...
**OPEN — TEST-ONLY (re-audited and reopened 2026-09-06, round VI research-34 — see the dated
addendum after the history below; this entry's own prior DONE marking predates that re-audit and
is kept as history, not rewritten).**
