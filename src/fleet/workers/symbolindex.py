...
"""A gRPC stub's wire-level RPC path, `/package.Service/Method` — this is the ONE string every
...
def scan_file(
    ...
    symbols.extend(
        _pattern_symbols(
            text, repo_id, rel, language, api_contract_patterns, kind=SymbolKind.GRPC_SERVICE
        )
    )
