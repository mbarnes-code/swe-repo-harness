...
SCHEMA_VERSION = 12  # == PRAGMA user_version (§6): 2 ADR-0019, 3 ADR-0021, 4 ADR-0022,
                     ...
                     #                          12 `budget_ledger.calls_made`/`max_calls`: the
                     #                             call-count run ceiling, which a `price: free`
                     #                             target cannot render inert the way it does
                     #                             `run_max_cost_usd` (ADR-0142)
